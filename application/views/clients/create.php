    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="/clients/store" method="POST">
                ...
                <!-- Updated section with Cancel and Save buttons -->
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="/clients" class="btn btn-secondary me-md-2">Cancel</a>
                    <button type="submit" class="btn btn-primary">Save Client</button>
                </div>
                
                <!-- Database error message with diagnostic link -->
                <?php if (isset($errors['db_error'])): ?>
                    <div class="alert alert-danger mt-3">
                        <?= htmlspecialchars($errors['db_error']) ?>
                        <hr>
                        <p class="mb-0">
                            <a href="/diagnostic/db" target="_blank">Run database diagnostics</a> to troubleshoot this issue.
                        </p>
                    </div>
                <?php endif; ?>
            </form>
